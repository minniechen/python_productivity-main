...
# 指定要合并excel的路径
src_path = '/Users/minnie.chen/Documents/code/python_productivity-main/文章1代码/调查问卷'
# 指定合并完成的路径
dst_file = '/Users/minnie.chen/Documents/code/python_productivity-main/文章1代码/result/结果.xlsx'
